          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="bg-green-50 rounded-xl p-6">
                <p className="text-gray-700 leading-relaxed mb-4">
                  WellSpring is designed with privacy at its core. When students
                  book counselling sessions, their real identity is completely
                  protected through our anonymous booking system.
                </p>
                <ul className="list-disc list-inside space-y-2 text-gray-600">
                  <li>
                    Counsellors never see student names, emails, or personal
                    identifiers
                  </li>
                  <li>
                    Students are assigned anonymous IDs for all interactions
                  </li>
                  <li>
                    Only wellness progress and session notes are shared with
                    counsellors
                  </li>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 mb-4">
                ...
                <li>
                  Wellness tracking data (mood entries, journal reflections)
                </li>
            ...
            <section>
              ...
              <p className="text-gray-600">
                ...
                data, please contact us at privacy@wellspring.edu
              </p>
            </section>
