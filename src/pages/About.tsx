...
const About: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br  from-blue-100 via-white to-green-500 opacity-80">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl p-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Empowering students to thrive through compassionate support and
              innovative wellness tools
            </p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    can access the tools and guidance they need for mental
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Your privacy is paramount. Students can access counselling
                    services completely anonymously, ensuring a judgment-free
                    space for growth.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Our network of qualified counsellors specializes in
                    student-specific challenges, from academic stress to
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    Beyond counselling, we provide comprehensive wellness
                    resources including mood tracking, educational content, and
                    community support.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-r from-blue-100 to-green-100 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Whether you're a student seeking support or a counsellor ready to
              make a difference, WellSpring provides the platform to connect,
